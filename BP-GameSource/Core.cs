    ...
    public class Core : Plugin
    {
        ...
        private JobInfo[] GetJobs => new JobInfo[] {
            new JobInfo(
                ...
                0, GroupIndex.Citizen, false, false, false, 0, new Color(0.75f, 0.75f, 0.75f), 1f, 28,
                new Transports[] {
                    new Transports(new string[] {
                        "Car1",
                        "Car2",
            ...
            new JobInfo(
                ...
                0, GroupIndex.Prisoner, false, false, false, 0, new Color(1f, 0.5f, 0f), 0f, 0,
                new Transports[] {
            ...
            new JobInfo(
                ...
                0, GroupIndex.Criminal, false, true, true, 0, new Color(0f, 0f, 0f), 0.02f, 5,
                new Transports[] {
                    new Transports(new string[0]),
                    new Transports(new string[0]),
                    new Transports(new string[0])
            ...
            new JobInfo(
                ...
                0, GroupIndex.LawEnforcement, false, false, false, 0, new Color(0f, 1f, 1f), 0.03f, 8,
                new Transports[] {
            ...
            new JobInfo(
                ...
                0, GroupIndex.Citizen, false, false, false, 0, new Color(1f, 0.75f, 0.75f), 0.02f, 5,
                new Transports[] {
            ...
            new JobInfo(
                ...
                0, GroupIndex.Citizen, false, false, false, 0, new Color(1f, 1f, 0f), 0.01f, 3,
                new Transports[] {
            ...
            new JobInfo(
                ...
                0, GroupIndex.Gang, false, false, false, 0, new Color(1f, 0f, 0f), 0.1f, 8,
                new Transports[] {
                    new Transports(new string[0]),
                    new Transports(new string[0]),
                    new Transports(new string[0])
            ...
            new JobInfo(
                ...
                "Kill enemy gangs to start a turf war and defeat enemy waves to capture territory",
                0, GroupIndex.Gang, false, false, false, 0, new Color(0f, 1f, 0f), 0.1f, 8,
                new Transports[] {
                    new Transports(new string[0]),
                    new Transports(new string[0]),
                    new Transports(new string[0])
            ...
            new JobInfo(
                ...
                "Kill enemy gangs to start a turf war and defeat enemy waves to capture territory",
                0, GroupIndex.Gang, false, false, false, 0, new Color(0f, 0f, 1f), 0.1f, 8,
                new Transports[] {
                    new Transports(new string[0]),
                    new Transports(new string[0]),
                    new Transports(new string[0])
            ...
            new JobInfo(
                ...
                1, GroupIndex.Citizen, false, true, true, 0, new Color(1f, 0f, 1f), 0f, 0,
                new Transports[] {
                    new Transports(new string[0]),
                    new Transports(new string[0]),
                    new Transports(new string[0])
            ...
            new JobInfo(
                ...
                0, GroupIndex.Citizen, true, false, false, 0, new Color(0.5f, 0.25f, 0f), 0f, 0,
                new Transports[] {
                    new Transports(new string[0]),
                    new Transports(new string[0]),
                    new Transports(new string[0])
            ...
            new JobInfo(
                ...
                0, GroupIndex.Citizen, false, false, false, 0, new Color(0f, 0f, 0.5f), 0f, 0,
                new Transports[0],
                new Upgrades[] {
                    new Upgrades(
                        new InventoryStruct[] {
            ...
            new JobInfo(
                ...
                0, GroupIndex.LawEnforcement, false, false, false, 0, new Color(0.75f, 0.75f, 0.25f), 0.01f, 3,
                new Transports[] {
                    new Transports(new string[] {
                        "TroopCar1",
                        "TroopCar2",
